...
export default [
  {
    ...
    tasks: [
      ...
      new mongoose.Types.ObjectId("a40000000000000000000000"),
      new mongoose.Types.ObjectId("a50000000000000000000000"),
      new mongoose.Types.ObjectId("a60000000000000000000000"),
      new mongoose.Types.ObjectId("a70000000000000000000000"),
      new mongoose.Types.ObjectId("a80000000000000000000000"),
      new mongoose.Types.ObjectId("a90000000000000000000000"),
      new mongoose.Types.ObjectId("aa0000000000000000000000"),
      new mongoose.Types.ObjectId("ab0000000000000000000000"),
      new mongoose.Types.ObjectId("ac0000000000000000000000"),
      new mongoose.Types.ObjectId("ad0000000000000000000000"),
    ],
